...
// This is a copy of the WPILib PIDController class, with the following changes:
// - Removed the Sendable
// - Removed any references to WPILib classes

// Source: https://github.com/wpilibsuite/allwpilib/blob/main/wpimath/src/main/java/edu/wpi/first/math/controller/PIDController.java
...
public class WPIPIDController extends PIDController {
     ...
     */
    public WPIPIDController(double kp, double ki, double kd) {
        this(kp, ki, kd, 0.02);
    }
